...
public class BusTicketing extends javax.swing.JFrame {
    ...
    private void jTextFieldFormActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jButtonTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTotalActionPerformed
       ...
       if(jComboBoxDestination.getSelectedItem().equals("MURREE") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("ISLMABAD");
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("MURREE") && jRadioButtonEconomy1.isSelected()&& 
                jRadioButtonSingle1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("murre");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("ISLAMABAD");
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("MURREE") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("KARACHI")&& jRadioButtonEconomy1.isSelected()&& 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
     int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
      jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("KARACHI");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");       
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("ISLAMABAD");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("KARACHI") && jRadioButtonFirstClass1.isSelected() && 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
           int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      ...
      jTextFieldDate2.setText(jDateChooser.getDate().toString());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("KAMRA") && jRadioButtonEconomy1.isSelected() 
               && jRadioButtonReturn1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
      
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("KAMRA");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("Round Trip");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("ISLAMABAD");
       ...
       jTextFieldTicketType.setText(null);
           ...
           else if(jComboBoxDestination.getSelectedItem().equals("KAMRA") && jRadioButtonFirstClass1.isSelected()
                   && jRadioButtonReturn1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   ...
   if(jComboBoxTime.getSelectedItem().equals("11:30")){
      ...
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("MULTAN")&& jRadioButtonEconomy1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
       int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
   
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("MULTAN");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("ISLAMABAD");
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("MULTAN") && jRadioButtonFirstClass1.isSelected()
                  && jRadioButtonReturn1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldTicketType.setText(null);
          ...
          else if(jComboBoxDestination.getSelectedItem().equals("SAKARDU")&& jRadioButtonEconomy1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
      int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
       jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("SAKARDU");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("ISLAMABAD");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("SAKARDU") && jRadioButtonFirstClass1.isSelected()
               && jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
         int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
